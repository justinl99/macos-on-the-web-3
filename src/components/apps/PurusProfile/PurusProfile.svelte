...
<section class="container">
  ...
  <aside class:light={$theme.scheme === 'light'}>
    <nav>
      ...
      <a href="https://twitter.com/Anhc02575791" use:external>
        <TwitterIcon />
        Twitter
      </a>
      <a href="https://github.com/hockerdiscord" use:external> <GithubIcon /> Github </a>
  ...
  <section class="content">
    <img
      height="200"
      width="200"
      src="https://avatars.githubusercontent.com/u/93564256?s=400&u=086eb1a66328127ac3f794f06001994b15768a28&v=4"
      alt="JustinL Profile pic"
    />

    <br />

    <h1>Hi, I'm JustinL</h1>

    <h2>
      I'm not the creator of macOS Web, I just custom the code from Puru Vj
